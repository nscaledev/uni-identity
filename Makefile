...
# spike-validated against (see docs/authorization/cerbos-authorization-design.md).
...
# Validate the committed Cerbos policy store: compile the generated policies
...
KIND_SUFFIX    ?= $(shell openssl rand -hex 4 2>/dev/null || echo local)

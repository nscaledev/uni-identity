...
// This file is the decision stash: a request-scoped accumulator of Allow*
...
// each — closing the finding that the front-door audit dropped
...
//
// Hooked at exactly two choke points, mirroring how the decision log
// (decision_log.go) hooks CheckMany rather than decorating every call site:
// dispatchCoarse (handler.go) is the single dispatch point behind AllowGlobalScope,

...
// TestGetACLEngineModeIndependence is the /acl engine-decoupling regression
// guard for the thin-Go ACL computation: GetACL's output must be identical whichever

...
// This file is the remote-shadow comparator: under
// RemoteShadow (the remote-engine context seam), dispatchCoarse (handler.go)
...
//
// The log taxonomy is load-bearing for the divergence gate:
//

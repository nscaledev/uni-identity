...
// This file is the downstream remote-authorization context seam: a remote
...
const (
	...
	// for comparison (the remote-shadow comparator, remoteShadowed) without
	// ever serving its decision.
	RemoteShadow
...
// for the remote dispatch fork.  Mirrors NewEngineContext exactly.

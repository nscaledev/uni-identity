...
// and the A10 decision audit logging and metrics all live in pkg/rbac
...
// maps this sentinel to deny — fail closed — and its A10 observability
...
// (deployment-B in the design doc) would need mTLS and revisits this.

...
// are the pinned reference for the bindings resolver, not builder branching.
...
// property the coarse-decision cache key and decision logging rely on.
...
// future coarse-decision cache key.

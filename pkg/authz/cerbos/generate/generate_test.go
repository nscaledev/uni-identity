...
func TestGenerateUnionAndDedup(t *testing.T) {
	...
	roles := []unikornv1.Role{
		role("00000000-0000-0000-0000-00000000000b", unikornv1.RoleScopes{
			Organization: []unikornv1.RoleScope{
				scope("radar:repairstats", unikornv1.Read, unikornv1.Read, unikornv1.Create),
			},
		}),
		role("00000000-0000-0000-0000-00000000000a", unikornv1.RoleScopes{
			Global: []unikornv1.RoleScope{
				scope("radar:repairstats", unikornv1.Update),
			},
		}),
	}
...
`
	...
	require.Equal(t, expected, string(files["resource_radar_repairstats.yaml"]))
}
...
func TestGenerateMergesDuplicateEndpoints(t *testing.T) {
	...
	roles := []unikornv1.Role{
		role("00000000-0000-0000-0000-00000000000a", unikornv1.RoleScopes{
			Organization: []unikornv1.RoleScope{
				scope("radar:repairstats", unikornv1.Read),
...
func TestGenerateInvalidInput(t *testing.T) {
	...
	cases := map[string]struct {
		...
		"EndpointNameWithGlobAsterisk": {
			roles: []unikornv1.Role{
				role("00000000-0000-0000-0000-00000000000a", unikornv1.RoleScopes{
					Organization: []unikornv1.RoleScope{scope("radar:*", unikornv1.Read)},
				}),
			},
			err: generate.ErrInvalidScope,
		},
		"EndpointNameWithGlobQuestionMark": {
			roles: []unikornv1.Role{
				role("00000000-0000-0000-0000-00000000000a", unikornv1.RoleScopes{
					Organization: []unikornv1.RoleScope{scope("radar:repairstats?", unikornv1.Read)},
				}),
			},
			err: generate.ErrInvalidScope,
		},
		"EndpointNameWithGlobBrackets": {
			roles: []unikornv1.Role{
				role("00000000-0000-0000-0000-00000000000a", unikornv1.RoleScopes{
					Organization: []unikornv1.RoleScope{scope("radar:repairstats[1]", unikornv1.Read)},
				}),
			},
			err: generate.ErrInvalidScope,
		},
	...
	roles := []unikornv1.Role{
		role("00000000-0000-0000-0000-00000000000a", unikornv1.RoleScopes{
			Organization: []unikornv1.RoleScope{
				...
				scope("radar:repair stats", unikornv1.Read),
				scope("radar:repairstats#detail", unikornv1.Read),
			},
		}),
	}

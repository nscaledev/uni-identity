...
// This file is the Cerbos request builder: a pure function from identity's
...
// bindings, and the decision mapping, are the decision layer.
...
const (
	...
	// the coarse checks it marks are exactly what the coarse-decision cache

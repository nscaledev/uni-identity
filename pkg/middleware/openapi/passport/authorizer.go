...
func NewAuthorizer(kubeClient client.Client, identityOptions *identityclient.Options, clientOptions *coreclient.HTTPClientOptions) (*Authorizer, error) {
	return NewAuthorizerWithOptions(kubeClient, identityOptions, clientOptions, nil)
}

// NewAuthorizerWithOptions builds a passport Authorizer from Kubernetes client and options.
func NewAuthorizerWithOptions(kubeClient client.Client, identityOptions *identityclient.Options, clientOptions *coreclient.HTTPClientOptions, authorizerOptions *Options) (*Authorizer, error) {
	options := authorizerOptions.withDefaults()

	uni, err := remoteauthorizer.NewAuthorizer(kubeClient, identityOptions, clientOptions)
	if err != nil {

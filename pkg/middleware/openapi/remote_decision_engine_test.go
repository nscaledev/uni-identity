...
// These tests pin downstream consumption of the remote-authorization seam: the
...
const (
	remoteSeedTestNamespace    = "remote-seed-test"
	remoteSeedTestCheckTimeout = 5 * time.Second
)
...
func newRemoteAuthorizerForSeedTest(t *testing.T, stub *checkStub, opts ...remoteauthorizer.Option) *remoteauthorizer.Authorizer {
	...
	opts = append([]remoteauthorizer.Option{remoteauthorizer.WithCheckTimeout(remoteSeedTestCheckTimeout)}, opts...)

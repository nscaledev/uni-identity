...
// generate builds the group the write asks for.  It also returns the principals
// the membership names, so the addition guard can compare them against the
// stored group without having to re-derive the pairing between the two

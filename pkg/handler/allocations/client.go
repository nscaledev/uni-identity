...
func (c *SyncClient) Update(ctx context.Context, organizationID string, projectID *string, allocationID string, request *openapi.AllocationUpdateRequest) (*openapi.AllocationRead, error) {

...
func (h *Handler) GetApiV1OrganizationsOrganizationIDRoles(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter) {
	if err := rbac.AllowOrganizationScope(r.Context(), "identity:roles", openapi.Read, organizationID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}

	result, err := roles.New(h.client, h.namespace).List(r.Context(), organizationID.String())
	if err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) GetApiV1OrganizationsOrganizationIDOauth2providers(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter) {
	if err := rbac.AllowOrganizationScope(r.Context(), "identity:oauth2providers", openapi.Read, organizationID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}

	result, err := oauth2providers.New(h.client, h.namespace).List(r.Context(), organizationID.String())
	if err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) PostApiV1OrganizationsOrganizationIDOauth2providers(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter) {
	if err := rbac.AllowOrganizationScope(r.Context(), "identity:oauth2providers", openapi.Create, organizationID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}
	...
	result, err := oauth2providers.New(h.client, h.namespace).Create(r.Context(), organizationID.String(), request)
	if err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) PutApiV1OrganizationsOrganizationIDOauth2providersProviderID(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter, providerID openapi.Oauth2ProvderIDParameter) {
	if err := rbac.AllowOrganizationScope(r.Context(), "identity:oauth2providers", openapi.Update, organizationID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) DeleteApiV1OrganizationsOrganizationIDOauth2providersProviderID(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter, providerID openapi.Oauth2ProvderIDParameter) {
	if err := rbac.AllowOrganizationScope(r.Context(), "identity:oauth2providers", openapi.Delete, organizationID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) GetApiV1OrganizationsOrganizationID(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter) {
	if err := rbac.AllowOrganizationScope(r.Context(), "identity:organizations", openapi.Read, organizationID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}

	result, err := organizations.New(h.client, h.namespace).Get(r.Context(), organizationID.String())
	if err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) PutApiV1OrganizationsOrganizationID(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter) {
	if err := rbac.AllowOrganizationScope(r.Context(), "identity:organizations", openapi.Update, organizationID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}
	...
	if err := organizations.New(h.client, h.namespace).Update(r.Context(), organizationID.String(), request); err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) DeleteApiV1OrganizationsOrganizationID(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter) {
	...
	if err := organizations.New(h.client, h.namespace).Delete(r.Context(), organizationID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) GetApiV1OrganizationsOrganizationIDGroups(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter) {
	if err := rbac.AllowOrganizationScope(r.Context(), "identity:groups", openapi.Read, organizationID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}

	result, err := groups.New(h.client, h.namespace, h.options.Issuer).List(r.Context(), organizationID.String())
	if err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) PostApiV1OrganizationsOrganizationIDGroups(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter) {
	if err := rbac.AllowOrganizationScope(r.Context(), "identity:groups", openapi.Create, organizationID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}
	...
	result, err := groups.New(h.client, h.namespace, h.options.Issuer).Create(r.Context(), organizationID.String(), request)
	if err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) DeleteApiV1OrganizationsOrganizationIDGroupsGroupid(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter, groupID openapi.GroupidParameter) {
	if err := rbac.AllowOrganizationScope(r.Context(), "identity:groups", openapi.Delete, organizationID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) PutApiV1OrganizationsOrganizationIDGroupsGroupid(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter, groupID openapi.GroupidParameter) {
	if err := rbac.AllowOrganizationScope(r.Context(), "identity:groups", openapi.Update, organizationID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) GetApiV1OrganizationsOrganizationIDProjects(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter) {
	result, err := projects.New(h.client, h.namespace).List(r.Context(), organizationID.String())
	if err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) PostApiV1OrganizationsOrganizationIDProjects(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter) {
	if err := rbac.AllowOrganizationScope(r.Context(), "identity:projects", openapi.Create, organizationID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}
	...
	result, err := projects.New(h.client, h.namespace).Create(r.Context(), organizationID.String(), request)
	if err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) GetApiV1OrganizationsOrganizationIDProjectsProjectID(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter, projectID openapi.ProjectIDParameter) {
	if err := rbac.AllowProjectScope(r.Context(), "identity:projects", openapi.Read, organizationID.String(), projectID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}

	result, err := projects.New(h.client, h.namespace).Get(r.Context(), organizationID.String(), projectID.String())
	if err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) PutApiV1OrganizationsOrganizationIDProjectsProjectID(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter, projectID openapi.ProjectIDParameter) {
	if err := rbac.AllowProjectScope(r.Context(), "identity:projects", openapi.Update, organizationID.String(), projectID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}
	...
	if err := projects.New(h.client, h.namespace).Update(r.Context(), organizationID.String(), projectID.String(), request); err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) DeleteApiV1OrganizationsOrganizationIDProjectsProjectID(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter, projectID openapi.ProjectIDParameter) {
	if err := rbac.AllowProjectScope(r.Context(), "identity:projects", openapi.Delete, organizationID.String(), projectID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}

	if err := projects.New(h.client, h.namespace).Delete(r.Context(), organizationID.String(), projectID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) PutApiV1OrganizationsOrganizationIDProjectsProjectIDReferencesReference(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter, projectID openapi.ProjectIDParameter, reference openapi.ReferenceParameter) {
	if err := rbac.AllowProjectScope(r.Context(), "identity:projects/references", openapi.Create, organizationID.String(), projectID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}

	if err := projects.New(h.client, h.namespace).ReferenceCreate(r.Context(), organizationID.String(), projectID.String(), reference); err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) DeleteApiV1OrganizationsOrganizationIDProjectsProjectIDReferencesReference(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter, projectID openapi.ProjectIDParameter, reference openapi.ReferenceParameter) {
	if err := rbac.AllowProjectScope(r.Context(), "identity:projects/references", openapi.Delete, organizationID.String(), projectID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}

	if err := projects.New(h.client, h.namespace).ReferenceDelete(r.Context(), organizationID.String(), projectID.String(), reference); err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) GetApiV1OrganizationsOrganizationIDServiceaccounts(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter) {
	...
	if err := allowServiceAccountOrSelfAccess(r.Context(), openapi.Read, organizationID.String(), ""); err != nil {
		errors.HandleError(w, r, err)
		return
	}

	result, err := h.serviceAccountsClient().List(r.Context(), organizationID.String())
	if err != nil {
		errors.HandleError(w, r, err)
		return
	}

	if err := filterServiceAccounts(r.Context(), organizationID.String(), &result); err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) PostApiV1OrganizationsOrganizationIDServiceaccounts(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter) {
	if err := rbac.AllowOrganizationScope(r.Context(), "identity:serviceaccounts", openapi.Create, organizationID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}
	...
	result, err := h.serviceAccountsClient().Create(r.Context(), organizationID.String(), request)
	if err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) PutApiV1OrganizationsOrganizationIDServiceaccountsServiceAccountID(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter, serviceAccountID openapi.ServiceAccountIDParameter) {
	if err := rbac.AllowOrganizationScope(r.Context(), "identity:serviceaccounts", openapi.Update, organizationID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) DeleteApiV1OrganizationsOrganizationIDServiceaccountsServiceAccountID(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter, serviceAccountID openapi.ServiceAccountIDParameter) {
	if err := rbac.AllowOrganizationScope(r.Context(), "identity:serviceaccounts", openapi.Delete, organizationID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) GetApiV1OrganizationsOrganizationIDUsers(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter) {
	if err := rbac.AllowOrganizationScope(r.Context(), "identity:users", openapi.Read, organizationID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}

	result, err := h.usersClient().List(r.Context(), organizationID.String())
	if err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) PostApiV1OrganizationsOrganizationIDUsers(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter) {
	if err := rbac.AllowOrganizationScope(r.Context(), "identity:users", openapi.Create, organizationID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}
	...
	result, err := h.usersClient().Create(r.Context(), organizationID.String(), request)
	if err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) DeleteApiV1OrganizationsOrganizationIDUsersUserID(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter, userID openapi.UserIDParameter) {
	if err := rbac.AllowOrganizationScope(r.Context(), "identity:users", openapi.Delete, organizationID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) PutApiV1OrganizationsOrganizationIDUsersUserID(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter, userID openapi.UserIDParameter) {
	if err := rbac.AllowOrganizationScope(r.Context(), "identity:users", openapi.Update, organizationID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) GetApiV1OrganizationsOrganizationIDQuotas(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter) {
	if err := rbac.AllowOrganizationScope(r.Context(), "identity:quotas", openapi.Read, organizationID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}

	result, err := h.quotasClient().Get(r.Context(), organizationID.String())
	if err != nil {
		errors.HandleError(w, r, err)
		return
	}
...
func (h *Handler) PutApiV1OrganizationsOrganizationIDQuotas(w http.ResponseWriter, r *http.Request, organizationID openapi.OrganizationIDParameter) {
	if err := rbac.AllowOrganizationScope(r.Context(), "identity:quotas", openapi.Update, organizationID.String()); err != nil {
		errors.HandleError(w, r, err)
		return
	}
	...
	result, err := h.quotasClient().Update(r.Context(), organizationID.String(), request)
	if err != nil {
		errors.HandleError(w, r, err)
		return
	}

...
import (
	...
	"github.com/unikorn-cloud/identity/pkg/provisioners/auth0organizationmember"
...
func (*Factory) Options() coremanager.ControllerOptions {
	return &auth0organizationmember.Options{}
}
...
func (*Factory) Reconciler(options *options.Options, controllerOptions coremanager.ControllerOptions, manager manager.Manager) reconcile.Reconciler {
	return coremanager.NewReconciler(options, controllerOptions, manager, auth0organizationmember.New)
}

// RegisterWatches adds any watches that would trigger a reconcile.
func (*Factory) RegisterWatches(manager manager.Manager, controller controller.Controller) error {
	if err := controller.Watch(source.Kind(manager.GetCache(), &unikornv1.Auth0OrganizationMember{}, &handler.TypedEnqueueRequestForObject[*unikornv1.Auth0OrganizationMember]{}, &predicate.TypedGenerationChangedPredicate[*unikornv1.Auth0OrganizationMember]{})); err != nil {
		return err
	}

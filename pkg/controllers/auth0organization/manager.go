...
import (
	...
	"github.com/unikorn-cloud/identity/pkg/provisioners/auth0organization"
...
func (*Factory) Options() coremanager.ControllerOptions {
	return &auth0organization.Options{}
}
...
func (*Factory) Reconciler(options *options.Options, controllerOptions coremanager.ControllerOptions, manager manager.Manager) reconcile.Reconciler {
	return coremanager.NewReconciler(options, controllerOptions, manager, auth0organization.New)
}

// RegisterWatches adds any watches that would trigger a reconcile.
func (*Factory) RegisterWatches(manager manager.Manager, controller controller.Controller) error {
	if err := controller.Watch(source.Kind(manager.GetCache(), &unikornv1.Auth0Organization{}, &handler.TypedEnqueueRequestForObject[*unikornv1.Auth0Organization]{}, &predicate.TypedGenerationChangedPredicate[*unikornv1.Auth0Organization]{})); err != nil {
		return err
	}

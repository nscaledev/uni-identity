...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BearerTrustSpec) DeepCopyInto(out *BearerTrustSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BearerTrustSpec.
func (in *BearerTrustSpec) DeepCopy() *BearerTrustSpec {
	if in == nil {
		return nil
	}
	out := new(BearerTrustSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OAuth2ProviderSpec) DeepCopyInto(out *OAuth2ProviderSpec) {
	*out = *in
	...
	if in.BearerTrust != nil {
		in, out := &in.BearerTrust, &out.BearerTrust
		*out = new(BearerTrustSpec)
		(*in).DeepCopyInto(*out)
	}
	return

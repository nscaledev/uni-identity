...
**16 of 17 core tasks landed on `cerbos-integration` (A12 = the cutover mechanism; its per-kind flip is operational, pending the shadow soak). Remaining core: A17 (legacy removal, after the flip). Follow-ups: A18 (a) static chart-assert; A19 (deferred); A23 (deferred).** _(updated 2026-07-13)_
